...
odir <- paste0(root,'/output/GEER/plot/0404/')
...
techpol <- c('Default','limCCS','limBio','H2low','Biofueloff')
# techpol <- c('Default')
...
g_pro_HVC_L <- VX5 %>%
  ...
  theme(legend.position = 'bottom')
plot(g_pro_HVC_L)
ggsave(paste0(odir,'production/production_HVC_L.png'),g_pro_HVC,width=10,height=8)
